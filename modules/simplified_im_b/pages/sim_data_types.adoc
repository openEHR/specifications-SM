...
image::ROOT:uml/SM-simplified_im_b.rm.data_types.svg[id=sm_simplified_im_b_rm_data_types, align="center"]
...
include::ROOT:partial$classes/s_data_value.adoc[]
include::ROOT:partial$classes/s_dv_identifier.adoc[]

include::ROOT:partial$classes/s_dv_text.adoc[]
include::ROOT:partial$classes/s_dv_coded_text.adoc[]
include::ROOT:partial$classes/s_code_phrase.adoc[]

include::ROOT:partial$classes/s_dv_parsable.adoc[]

include::ROOT:partial$classes/s_dv_quantity.adoc[]
include::ROOT:partial$classes/s_dv_count.adoc[]
include::ROOT:partial$classes/s_dv_proportion.adoc[]
include::ROOT:partial$classes/s_dv_ordinal.adoc[]
