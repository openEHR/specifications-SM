...
image::ROOT:uml/SM-platform.interface.query.svg[id=platform_interface_query, align="center"]
...
include::ROOT:partial$classes/i_query_service.adoc[]

include::ROOT:partial$classes/stored_query_execute_spec.adoc[]

include::ROOT:partial$classes/adhoc_query_execute_spec.adoc[]

include::ROOT:partial$classes/result_set.adoc[]

include::ROOT:partial$classes/result_set_column.adoc[]

include::ROOT:partial$classes/result_set_row.adoc[]
