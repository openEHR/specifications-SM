...
image::ROOT:uml/SM-platform.interface.definitions.svg[id=sm_platform_interface_definitions, align="center"]
...
include::ROOT:partial$classes/i_definition_adl2.adoc[]

include::ROOT:partial$classes/i_definition_adl14.adoc[]

include::ROOT:partial$classes/i_definition_query.adoc[]

include::ROOT:partial$classes/definition_call_status_type.adoc[]

include::ROOT:partial$classes/query_descriptor.adoc[]
