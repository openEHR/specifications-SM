...
image::diagrams/assumed_model.svg[id=assumed_model, align="center"]
...
image::ROOT:uml/SM-platform.definition.svg[id=platform_definition, align="center"]
...
image::ROOT:uml/SM-platform-packages.svg[id=platform_packages, align="center"]
