...
image::ROOT:uml/SM-platform.interface.ehr_index.svg[id=platform_interface_ehr_index, align="center"]
...
include::ROOT:partial$classes/i_ehr_index.adoc[]

include::ROOT:partial$classes/resource_status.adoc[]

include::ROOT:partial$classes/resource_instance_type.adoc[]

include::ROOT:partial$classes/location_desc.adoc[]
